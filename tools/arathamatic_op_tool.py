...
from langchain_community.utilities.alpha_vantage import AlphaVantageAPIWrapper #to convert into different currencies
...
def currency_converter(from_curr: str, to_curr: str, value: float)->float:
    ...
    alpha_vantage = AlphaVantageAPIWrapper()#to convert into different currencies
