...
#calling all the tool that I have created
...
class GraphBuilder():
    ...
    def __init__(self,model_provider: str = "groq"):
        ...
        self.tools = []#collecting all teh tool inside this list

        #created objects of the tools
        self.weather_tools = WeatherInfoTool()
        self.place_search_tools = PlaceSearchTool()
        self.calculator_tools = CalculatorTool()
        self.currency_converter_tools = CurrencyConverterTool()
        
        self.tools.extend([* self.weather_tools.weather_tool_list, #creating teh list out of the tool
                           * self.place_search_tools.place_search_tool_list,
                           * self.calculator_tools.calculator_tool_list,
                           * self.currency_converter_tools.currency_converter_tool_list])
        
        self.llm_with_tools = self.llm.bind_tools(tools=self.tools)#binding the tools to llm
        
        self.graph = None #initially the graph is none but later it will be initailized
